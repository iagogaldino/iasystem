        ...
        try:
            ...
            try:
                ...
                if no_numbering:
                    ...
                    path = main_directory + "/" + prefix + "."+format
                ...
                download_status = 'success'
                download_message = "Completed Image ====> : D " + prefix + str(count) + "." + image_name
    ...
    def download(self, arguments):
        ...
        if __name__ != "__main__":
            ...
            # if the calling file contains params directly
                ...
                return paths_agg, errors, nameItemValue
